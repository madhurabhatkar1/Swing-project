...
c1=new Color(255, 195, 0 );
ImageIcon framebg=new ImageIcon("hillstation.png");
this.setContentPane(new JLabel(framebg));
l1=new JLabel("Hill Station Wedding");
...
vl2.setForeground(c2);
add(vl2);
vcb1=new JCheckBox("MUSSOORIE");
vcb1.setBounds(100,200,150,20);
vcb1.setForeground(c1);
add(vcb1);
vcb2=new JCheckBox("MAHABALESHWAR");
vcb2.setBounds(100,250,150,20);
vcb2.setForeground(c1);
add(vcb2);
vcb3=new JCheckBox("GULMARG");
vcb3.setBounds(100,300,150,20);
vcb3.setForeground(c1);
add(vcb3);
vcb4=new JCheckBox("OOTY");
vcb4.setBounds(100,350,150,20);
vcb4.setForeground(c1);
add(vcb4);
...
if(e.getSource()==b){
    // if(pcb22.isSelected()){ 
        // else if(pcb22.isSelected()){
    JOptionPane.showMessageDialog(this,"BOOKING CONFIRMED, THANK YOU FOR VISITING ");
    first.dispose();
    new home(userID);
    // }
// }
